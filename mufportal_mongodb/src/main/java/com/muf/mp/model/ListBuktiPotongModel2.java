...
public class ListBuktiPotongModel2 {
	...
	public ListBuktiPotongModel2(//String JENIS_PPH, 
			String TAHUN_PAJAK, String MASA_PAJAK, String NOMOR_BUPOT,
			String IDENTITAS_DIPOTONG, 
			//String JENIS_IDENTITAS_DIPOTONG, 
			String NAMA_DIPOTONG,
			String DEALER_CODE
			/*String KODE_OBJEK_PAJAK, BigDecimal JUMLAH_BRUTO,
